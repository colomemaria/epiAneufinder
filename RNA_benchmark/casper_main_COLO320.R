# ------------------------------------------------------------------------------
# Run CaSpER on the COLO320 dataset
# ------------------------------------------------------------------------------
...
input_file<-"data/input_COLO320/count_matrix.txt"
input_annotations<-"data/input_COLO320/sample_annotation.txt"
input_gene_annot<-"data/input_COLO320/annotation_genes_COLO320.tsv"
input_af<-"results/output_COLO320/casper/COLO320_BAFExtract_af/COLO320.af"

input_segment_gamma<-7

output_casper_object<-"results/output_COLO320/casper/COLO320_casper_object_final.RDS"
output_casper_segments<-"results/output_COLO320/casper/COLO320_casper_segments.tsv"
output_casper_pseudobulk<-"results/output_COLO320/casper/COLO320_casper_pseudobulk_aggregate.RDS"
 
output_plot_density<-"results/output_COLO320/casper/COLO320_casper_densities.pdf"
output_plot_large_events<-"results/output_COLO320/casper/COLO320_casper_large_events.png"
output_plot_heatmap<-"results/output_COLO320/casper/COLO320_casper_heatmap.png"
output_plot_baf<-"results/output_COLO320/casper/COLO320_casper_baf.png"
...
cancer_cells <- meta_data$cell[meta_data$sample %in% "HTC116"]
